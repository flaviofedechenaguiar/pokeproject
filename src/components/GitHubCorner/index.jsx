export const GitHubCorner = () => {
    return (<>
        <StyleGitHubCorner />
        <a href="https://github.com/flaviofedechenaguiar/pokeproject" className="github-corner" ariaLabel="View source on GitHub">
            <svg width="101" height="101" viewBox="0 0 250 250" style={{ "fill": "#fff", "color": "var(--chakra-colors-gray-800)", "position": "absolute", "top": "0", "border": "0", "right": "0" }} ariaHidden="true">
